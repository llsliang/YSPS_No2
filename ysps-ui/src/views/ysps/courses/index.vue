<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程类型" prop="coursetype">
        <el-select v-model="queryParams.coursetype" placeholder="请选择课程类型" clearable>
          <el-option
            v-for="dict in dict.type.coursesclass"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ysps:courses:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ysps:courses:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="coursesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程时间" align="center" prop="classtime" />
      <el-table-column label="课程地点" align="center" prop="location" />
      <el-table-column label="课程类型" align="center" prop="coursetype">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.coursesclass" :value="scope.row.coursetype"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程时间" prop="classtime">
          <el-input v-model="form.classtime" placeholder="请输入课程时间" />
        </el-form-item>
...
<script>
import { listCourses, getCourses, delCourses, addCourses, updateCourses } from "@/api/ysps/courses";
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.reset();
      this.open = true;
      this.title = "添加包含课程信息，如课程名称、教师、时间和地点";
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      this.reset();
      ...
      getCourses(courseid).then(response => {
        ...
        this.open = true;
        this.title = "修改包含课程信息，如课程名称、教师、时间和地点";
      });
    },
    /** 提交按钮 */
    submitForm() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除包含课程信息，如课程名称、教师、时间和地点编号为"' + courseids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ysps/courses/export', {
        ...this.queryParams
